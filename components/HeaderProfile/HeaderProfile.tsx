            ...
            <div className="bg-greenLengs py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between px-5 shadow rounded-t">
                ...
                <div className="flex items-center  sm:mb-0 md:mb-0 lg:mb-0 xl:mb-0">
                    <div className="relative w-24 h-24 ">
                        <Image className="" width="100%" height="100%" src="/img/user.png" alt="avatar" />
                    </div>
                    <div className="ml-2">
                        <h2 className="text-black text-sm font-semibold">CryptoNahue</h2>
                        <p className="font-normal text-xs text-gray-600 dark:text-gray-400 cursor-pointer hover:text-gray-700">Edit Profile</p>
                    </div>
                </div>
