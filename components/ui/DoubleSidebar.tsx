...
>(({ className, ...props }, ref) => (
  <DoubleSidebarPrimitive.Overlay
    className={cn(
      'fixed inset-1 left-80 z-50 bg-background/10 bg-opacity-60 opacity-100 backdrop-blur-[2px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className
    )}
    {...props}
    ref={ref}
  ...
  'fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
        ...
        left: 'inset-y-0 ml-24 h-full border-r sm:max-w-sm data-[state=closed]:slide-out-to-left-1/4 data-[state=open]:slide-in-from-left-[10px] data-[state=closed]:animate-fadeRight',
        right:
