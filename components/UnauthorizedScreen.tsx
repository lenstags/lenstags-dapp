...
export const UnauthorizedScreen = () => {
  ...
  return (
    <div className="hero flex min-h-screen items-center justify-center bg-black">
        ...
        <div className="max-w-md ">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="btn hover:bg-LensGreen flex items-center gap-1 rounded-lg border-none bg-lensGreen px-6  py-2 text-black"
            >
              <svg
