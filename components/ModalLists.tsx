...
const ModalList: React.FC<ModalProps> = ({
  ...
  // const firstList = JSON.parse(listAttributeObj?.value) || [];
  // console.log('firstList ', firstList);
  // console.log('modallist component lensProfile?.attributes ', lensProfile);

  // para que uso first list?

  // const [lists, setLists] = useState<typeList[]>(firstList); //default value
  // const [lists, setLists] = useState<typeList[]>(); //default value deprecated
